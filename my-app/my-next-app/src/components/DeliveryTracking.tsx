      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex mb-4">
            <div className="ml-4">
              <h3 className="text-lg font-medium">{activeOrder.menuItem.name}</h3>
              <p className="text-gray-600">{activeOrder.menuItem.description}</p>
              <p className="text-yellow-600 font-medium mt-2">
                ${activeOrder.menuItem.price}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              ...
              <span className="font-medium">{activeOrder.customer.name}</span>
            </div>
            <div className="flex items-center">
