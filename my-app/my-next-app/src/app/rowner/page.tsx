                ...
                {[
                  {
                    ...
                    address: "123 Italian St, New York, NY 10001",
                    image: "/placeholder.svg?height=80&width=80",
                  },
                  {
                    name: "Sushi Master",
                    description: "Premium sushi and Japanese cuisine",
                    address: "456 Sushi Ave, New York, NY 10022",
                    image: "/placeholder.svg?height=80&width=80",
                  },
                ].map((restaurant) => (
                  <div key={restaurant.name} className="flex gap-4 p-4 border rounded-lg hover:bg-gray-50">
                    <Image
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="px-2 py-1 text-xs bg-gray-100 rounded-full">Inactive</span>
                      </div>
