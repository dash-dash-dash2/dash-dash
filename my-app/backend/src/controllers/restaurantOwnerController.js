...
const bcrypt = require('bcrypt');
  ...
  module.exports = { registerRestaurantOwner, getRestaurantsByOwner, addRestaurant, updateRestaurant, deleteRestaurant,getOwnerProfile,updateOwnerProfile,addMenu };
