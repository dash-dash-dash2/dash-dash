  ...
  const { 
    ...
    addMenu,
    addCategoryToRestaurant  // Importing addCategoryToRestaurant
  ...
  // Route to add a category to a restaurant
  router.post("/category/add/:restaurantId", addCategoryToRestaurant);
